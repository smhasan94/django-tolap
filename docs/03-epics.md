...
## E5. Example app, benchmark, README, upstream issue — status: todo

| Story | Title | FRs | Depends on | Status |
| --- | --- | --- | --- | --- |
| E5-S1 | `examples/clinic` app with seed command | FR-17 | E2-S7 | todo |
| E5-S2 | Benchmark script: SQL, rows fetched, RSS, latency | FR-17 | E5-S1 | todo |
